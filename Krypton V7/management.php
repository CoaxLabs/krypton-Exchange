	...
	<body>
        ...
        <div id="divh2formb">
                ...
                <div>
                    ...
                    if($_SESSION["admin"]>1){
                        echo '<h4 class="display-2"><span id="divh3" >Access Granted<br>Site members infos</span></h4>';
                    }
                    else{
                        echo '<h4 class="display-2"><span id="divh2formb">Acces Denied</span><br>Contact <a href="support.php" class="btn btn-primary active">support</a> if you think it\'s a mistake</h4>';
                    }
